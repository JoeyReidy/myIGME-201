    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            string[] s = { "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like" };
            linkedList = new LinkedList<object>(s);
            string[] roof = { "a", "room", "without", "a", "roof" };
            foreach (string word in roof)
            {
            ...
            string[] sad = { "sadness", "is", "the", "truth", "sad"};
            foreach (string word in sad)
            {
                linkedList.AddLast(word);
            }
            ...
            foreach (LinkedListNode<object> node in linkedList)
            {
                ...
                {
                    linkedList.AddBefore(linkedList.Find("sad"), "happy");
                    linkedList.Remove("sad");
                }
            }
            linkedList.AddBefore(linkedList.Find("sadness"), "happiness");
            linkedList.Remove("sadness");
            // 5. then call the visualizer
            VisualizeLinkedList visualizeLinkedList = new VisualizeLinkedList(linkedList);
        }
