...
namespace BTree
{
    public partial class BTreeForm : Form
    {
        ...
        private void Exercise2__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            node = new BTree(7, null);
            node.isData = false;
            root = node;
            node = new BTree(14, root);
            node = new BTree(21, root);
            node = new BTree(28, root);
            node = new BTree(35, root);
            node = new BTree(42, root);
            node = new BTree(49, root);
        ...
        private void Exercise3__Click(object sender, EventArgs e)
        {
            ...
            for(int i = 0; i < 15; i++)
            {
                node = new BTree(Convert.ToString(random.Next(1, 26)).ToUpper(), root);
        ...
        private void Exercise6__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            person = new Person("Joey", 20);
            node = new BTree(person, null);
            root = node;
            person = new Person("Mom", 45);
            node = new BTree(person, root);
            person = new Person("Dad", 49);
            node = new BTree(person, null);
            person = new Person("Brendan", 16);
            node = new BTree(person, null);
            person = new Person("Tommy", 14);
            node = new BTree(person, null);
            person = new Person("Alaska(dog)", 3);
            node = new BTree(person, null);
            person = new Person("Grandpa", 65);
            node = new BTree(person, null);
            person = new Person("Grandma", 64);
            node = new BTree(person, null);
            person = new Person("Aunt Sharyn", 42);
            node = new BTree(person, null);
            person = new Person("Uncle Billy", 45);
            node = new BTree(person, null);
            person = new Person("Rachel", 20);
            node = new BTree(person, null);
            person = new Person("Olivia", 1);
            node = new BTree(person, null);
            person = new Person("Jacklyn", 22);
            node = new BTree(person, null);
            person = new Person("Niclole", 22);
            node = new BTree(person, null);
            person = new Person("Star", 17);
            node = new BTree(person, null);
