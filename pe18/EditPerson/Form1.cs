...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            this.froshRadioButton.CheckedChanged += new EventHandler(this.FroshRadioButton__CheckedChanged);
            ...
            if((person.name == null) || (person.eGender == genderPronoun.them))
            {
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            else if (this.herRadioButton.Checked == true)
            {
                person.eGender = genderPronoun.her;
            }
            else if (this.themRadioButton.Checked == true)
            {
            ...
            if( person.GetType() == typeof( Student))
            {
                ...
                if (this.froshRadioButton.Checked == true)
                {
                    student.eCollegeYear = collegeYear.freshman;
                }
                else if (this.sophRadioButton.Checked == true)
                {
                    student.eCollegeYear = collegeYear.sophomore;
                }
                else if (this.juniorRadioButton.Checked == true)
                {
                    student.eCollegeYear = collegeYear.junior; ;
                }
                else if (this.seniorRadioButton.Checked == true)
                {
        ...
        private void FroshRadioButton__CheckedChanged(object sender, EventArgs e)
        {
