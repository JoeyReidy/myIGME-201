    ...
    class PeopleApp
    {
                    ...
                    case "list":
                        ...
                        foreach (KeyValuePair<string, Person> thisEntry in people.sortedList)
                        {
                            ...
                            if (thisPerson.GetType() == typeof(Student))
                            {
                                ...
                                foreach (string courseCode in student.CourseList)
                                {

                                    if(courses.sortedList.TryGetValue(courseCode, out Course course))
                                    {
                                        Console.WriteLine(courseCode + " " + course.description);
        ...
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (thisPerson.GetType() == typeof(Student))
            {
                ...
                do
                {
                    Console.Write("Enter course codes:");
